...
# O padrão é manter fora da classe do subset para adaptar conforme necessidade
# a ideia é utilizar uma vez por dataset
def transform_mnist(img, mean=33.0, std=76.5):
    # Conversão PIL->numpy
